...
const CreateBooking = memo(({ onSubmitSuccess }) => {
  ...
  const [createBookingAction, { loading: isSubmitting }] = useMutation(
  ...
  const formSchema = [
    {
      ...
      validators: [
        { type: "required", message: "Meeting Room choice is mandatory" },
      ],
    ...
    },
    {
      ...
      validators: [
        {
          type: "required",
          message: "Start timeline context window is required",
        },
      ],
    },
    {
      ...
      validators: [
        {
          type: "required",
          message: "Conclusion benchmark timeline is mandatory",
        },
      ],
    },
    {
      ...
      validators: [
        { type: "required", message: "Agenda explanation is required" },
      ],
    },
    {
                  ...
                  return (
                    <div key={item.equipmentId} className="list-item">
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          handleRemoveEquipmentClick(item.equipmentId)
                        }
